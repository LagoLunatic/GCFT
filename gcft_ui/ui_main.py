...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOpenGCMRARC = QAction(MainWindow)
        self.actionOpenGCMRARC.setObjectName(u"actionOpenGCMRARC")
        self.actionReplaceGCMRARC = QAction(MainWindow)
        self.actionReplaceGCMRARC.setObjectName(u"actionReplaceGCMRARC")
        self.actionOpenGCMJPC = QAction(MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpenGCMRARC.setText(QCoreApplication.translate("MainWindow", u"Open RARC", None))
