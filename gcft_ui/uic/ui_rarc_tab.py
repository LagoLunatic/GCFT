...
class Ui_RARCTab(object):
    def setupUi(self, RARCTab):
        ...
        self.actionOpenRARCRARC = QAction(RARCTab)
        self.actionOpenRARCRARC.setObjectName(u"actionOpenRARCRARC")
    ...
    def retranslateUi(self, RARCTab):
        ...
        self.actionOpenRARCRARC.setText(QCoreApplication.translate("RARCTab", u"Open RARC", None))
